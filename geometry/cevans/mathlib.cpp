...
boolc d3matsolve(point3<double> & x, point3<double> const & a0,  // Column vector.
	...
	return d3matsolve(x.x, x.y, x.z, a0.x, a1.x, a2.x, a0.y, a1.y, a2.y, a0.z, a1.z, a2.z, c.x, c.y, c.z);
}
...
void transrotate2D::eval(point2<double> & p, point2<double> const & shift) {
	p -= shift;
	eval(p);
	p += shift;
}
