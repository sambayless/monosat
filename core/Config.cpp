...
BoolOption Minisat::opt_interpolants_permanent(_cat_sms,"interpolants-permanent","False if interpolant clauses should be treated as learnt clauses (ie, can be deleted by the solver)",true);
