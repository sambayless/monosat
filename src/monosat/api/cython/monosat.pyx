...
from monosat_cython cimport BVTheoryPtr

from monosat_cython cimport FlowRouterPtr
from monosat_cython cimport GraphTheorySolver_double
from monosat_cython cimport GraphTheorySolver_long
from monosat_cython cimport SolverPtr
from monosat_cython cimport Var
from monosat_cython cimport Weight
from monosat_cython cimport acyclic_directed as _acyclic_directed_monosat
from monosat_cython cimport acyclic_undirected as _acyclic_undirected_monosat
from monosat_cython cimport addBinaryClause as _addBinaryClause_monosat
from monosat_cython cimport addBinaryClauses as _addBinaryClauses_monosat
from monosat_cython cimport addClause as _addClause_monosat
from monosat_cython cimport addRoutingNet as _addRoutingNet_monosat
from monosat_cython cimport addTertiaryClause as _addTertiaryClause_monosat
from monosat_cython cimport addUnitClause as _addUnitClause_monosat
from monosat_cython cimport assertPB_eq as _assertPB_eq_monosat
from monosat_cython cimport assertPB_geq as _assertPB_geq_monosat
from monosat_cython cimport assertPB_gt as _assertPB_gt_monosat
from monosat_cython cimport assertPB_leq as _assertPB_leq_monosat
from monosat_cython cimport assertPB_lt as _assertPB_lt_monosat
from monosat_cython cimport at_most_one as _at_most_one_monosat
from monosat_cython cimport backtrack as _backtrack_monosat
from monosat_cython cimport bv_addition as _bv_addition_monosat
from monosat_cython cimport bv_and as _bv_and_monosat
from monosat_cython cimport bv_bitblast as _bv_bitblast_monosat
from monosat_cython cimport bv_concat as _bv_concat_monosat
from monosat_cython cimport bv_divide as _bv_divide_monosat
from monosat_cython cimport bv_ite as _bv_ite_monosat
from monosat_cython cimport bv_max as _bv_max_monosat
from monosat_cython cimport bv_min as _bv_min_monosat
from monosat_cython cimport bv_multiply as _bv_multiply_monosat
from monosat_cython cimport bv_nand as _bv_nand_monosat
from monosat_cython cimport bv_nor as _bv_nor_monosat
from monosat_cython cimport bv_not as _bv_not_monosat
from monosat_cython cimport bv_or as _bv_or_monosat
from monosat_cython cimport bv_popcount as _bv_popcount_monosat
from monosat_cython cimport bv_slice as _bv_slice_monosat
from monosat_cython cimport bv_subtraction as _bv_subtraction_monosat
from monosat_cython cimport bv_unary as _bv_unary_monosat
from monosat_cython cimport bv_width as _bv_width_monosat
from monosat_cython cimport bv_xnor as _bv_xnor_monosat
from monosat_cython cimport bv_xor as _bv_xor_monosat
from monosat_cython cimport clearOptimizationObjectives as _clearOptimizationObjectives_monosat
from monosat_cython cimport createFlowRouting as _createFlowRouting_monosat
from monosat_cython cimport deleteSolver as _deleteSolver_monosat
from monosat_cython cimport disablePreprocessing as _disablePreprocessing_monosat
from monosat_cython cimport disallowLiteralSimplification as _disallowLiteralSimplification_monosat
from monosat_cython cimport flushPB as _flushPB_monosat

from monosat_cython cimport getConflictClause as _getConflictClause_monosat
from monosat_cython cimport getDecisionPolarity as _getDecisionPolarity_monosat
from monosat_cython cimport getDecisionPriority as _getDecisionPriority_monosat
from monosat_cython cimport getModel_AcyclicEdgeFlow as _getModel_AcyclicEdgeFlow_monosat
from monosat_cython cimport getModel_BV as _getModel_BV_monosat
from monosat_cython cimport getModel_EdgeFlow as _getModel_EdgeFlow_monosat
from monosat_cython cimport getModel_Literal as _getModel_Literal_monosat
from monosat_cython cimport getModel_MaxFlow as _getModel_MaxFlow_monosat
from monosat_cython cimport getModel_MinimumSpanningTreeWeight as _getModel_MinimumSpanningTreeWeight_monosat
from monosat_cython cimport getModel_Path_EdgeLits as _getModel_Path_EdgeLits_monosat
from monosat_cython cimport getModel_Path_EdgeLits_Length as _getModel_Path_EdgeLits_Length_monosat
from monosat_cython cimport getModel_Path_Nodes as _getModel_Path_Nodes_monosat
from monosat_cython cimport getModel_Path_Nodes_Length as _getModel_Path_Nodes_Length_monosat
from monosat_cython cimport getVersion as _getVersion_monosat
from monosat_cython cimport graph_setAssignEdgesToWeight as _graph_setAssignEdgesToWeight_monosat
from monosat_cython cimport initBVTheory as _initBVTheory_monosat

from monosat_cython cimport isDecisionVar as _isDecisionVar_monosat
from monosat_cython cimport lastSolutionWasOptimal as _lastSolutionWasOptimal_monosat
from monosat_cython cimport maximizeBV as _maximizeBV_monosat
from monosat_cython cimport maximizeLits as _maximizeLits_monosat
from monosat_cython cimport maximizeWeightedLits as _maximizeWeightedLits_monosat
from monosat_cython cimport maximumFlow_geq as _maximumFlow_geq_monosat
from monosat_cython cimport maximumFlow_geq_bv as _maximumFlow_geq_bv_monosat
from monosat_cython cimport maximumFlow_gt as _maximumFlow_gt_monosat
from monosat_cython cimport maximumFlow_gt_bv as _maximumFlow_gt_bv_monosat
from monosat_cython cimport minimizeBV as _minimizeBV_monosat
from monosat_cython cimport minimizeLits as _minimizeLits_monosat
from monosat_cython cimport minimizeWeightedLits as _minimizeWeightedLits_monosat
from monosat_cython cimport minimumSpanningTree_leq as _minimumSpanningTree_leq_monosat
from monosat_cython cimport minimumSpanningTree_lt as _minimumSpanningTree_lt_monosat
from monosat_cython cimport nBitvectors as _nBitvectors_monosat
from monosat_cython cimport nClauses as _nClauses_monosat
from monosat_cython cimport nEdges as _nEdges_monosat
from monosat_cython cimport nNodes as _nNodes_monosat
from monosat_cython cimport nVars as _nVars_monosat
from monosat_cython cimport newBVComparison_bv_geq as _newBVComparison_bv_geq_monosat
from monosat_cython cimport newBVComparison_bv_gt as _newBVComparison_bv_gt_monosat
from monosat_cython cimport newBVComparison_bv_leq as _newBVComparison_bv_leq_monosat
from monosat_cython cimport newBVComparison_bv_lt as _newBVComparison_bv_lt_monosat
from monosat_cython cimport newBVComparison_const_geq as _newBVComparison_const_geq_monosat
from monosat_cython cimport newBVComparison_const_gt as _newBVComparison_const_gt_monosat
from monosat_cython cimport newBVComparison_const_leq as _newBVComparison_const_leq_monosat
from monosat_cython cimport newBVComparison_const_lt as _newBVComparison_const_lt_monosat
from monosat_cython cimport newBitvector as _newBitvector_monosat
from monosat_cython cimport newBitvector_anon as _newBitvector_anon_monosat
from monosat_cython cimport newBitvector_const as _newBitvector_const_monosat
from monosat_cython cimport newEdge as _newEdge_monosat
from monosat_cython cimport newEdgeSet as _newEdgeSet_monosat
from monosat_cython cimport newEdge_bv as _newEdge_bv_monosat
from monosat_cython cimport newEdge_double as _newEdge_double_monosat

from monosat_cython cimport newGraph as _newGraph_monosat
from monosat_cython cimport newNode as _newNode_monosat
from monosat_cython cimport newSolver as _newSolver_monosat
from monosat_cython cimport newSolver_arg as _newSolver_arg_monosat
from monosat_cython cimport newState as _newState_monosat
from monosat_cython cimport newString as _newString_monosat
from monosat_cython cimport newTransition as _newTransition_monosat
from monosat_cython cimport newVar as _newVar_monosat
from monosat_cython cimport reaches as _reaches_monosat
from monosat_cython cimport readGNF as _readGNF_monosat
from monosat_cython cimport setConflictLimit as _setConflictLimit_monosat
from monosat_cython cimport setDecisionPolarity as _setDecisionPolarity_monosat
from monosat_cython cimport setDecisionPriority as _setDecisionPriority_monosat
from monosat_cython cimport setDecisionVar as _setDecisionVar_monosat
from monosat_cython cimport setMemoryLimit as _setMemoryLimit_monosat
from monosat_cython cimport setOutputFile as _setOutputFile_monosat
from monosat_cython cimport setPropagationLimit as _setPropagationLimit_monosat
from monosat_cython cimport setTimeLimit as _setTimeLimit_monosat
from monosat_cython cimport shortestPathUnweighted_leq_const as _shortestPathUnweighted_leq_const_monosat
from monosat_cython cimport shortestPathUnweighted_lt_const as _shortestPathUnweighted_lt_const_monosat
from monosat_cython cimport shortestPath_leq_bv as _shortestPath_leq_bv_monosat
from monosat_cython cimport shortestPath_leq_const as _shortestPath_leq_const_monosat
from monosat_cython cimport shortestPath_lt_bv as _shortestPath_lt_bv_monosat
from monosat_cython cimport shortestPath_lt_const as _shortestPath_lt_const_monosat
from monosat_cython cimport solve as _solve_monosat
from monosat_cython cimport solveAssumptions as _solveAssumptions_monosat
from monosat_cython cimport solveAssumptionsLimited as _solveAssumptionsLimited_monosat
from monosat_cython cimport solveLimited as _solveLimited_monosat
from monosat_cython cimport true_lit as _true_lit_monosat


def acyclic_directed( S ,  G ):
    """Cython signature: int acyclic_directed(void* S, void* G)"""
    assert isinstance(S, (object)), 'arg S wrong type'
...
def addBinaryClause( S ,  lit1 ,  lit2 ):
    ...
    cdef bint _r = _addBinaryClause_monosat((<void*>S), (<int>lit1), (<int>lit2))
    py_result = <bint>_r
    return py_result
...
def addBinaryClauses( S ,  first_args ,  second_args ,  n_pairs ):
    ...
    _addBinaryClauses_monosat((<void*>S), (<int*>a.data.as_ints),(<int*>b.data.as_ints), (<int>n_pairs))
...
def addClause( S ,  lits ,  n_lits ):
    ...
    cdef bint _r = _addClause_monosat((<void*>S), (<int*>a.data.as_ints), (<int>n_lits))
    py_result = <bint>_r
    return py_result
...
def addRoutingNet( S ,  G ,  router ,  disabledEdge ,  n_members ,  edge_lits ,  reach_lits ):
    ...
    _addRoutingNet_monosat((<void*>S), (<void*>G), (<void*>router), (<int>disabledEdge), (<int>n_members), (<int*>a.data.as_ints), (<int*>b.data.as_ints))
...
def addTertiaryClause( S ,  lit1 ,  lit2 ,  lit3 ):
    ...
    cdef bint _r = _addTertiaryClause_monosat((<void*>S), (<int>lit1), (<int>lit2), (<int>lit3))
    py_result = <bint>_r
    return py_result
...
def addUnitClause( S ,  lit ):
    ...
    cdef bint _r = _addUnitClause_monosat((<void*>S), (<int>lit))
    py_result = <bint>_r
    return py_result
...
def assertPB_eq( S ,  rhs ,  n_args ,  literals ,  coefficients ):
    ...
    _assertPB_eq_monosat((<void*>S), (<int>rhs), (<int>n_args), (<int*>a.data.as_ints), (<int*>b.data.as_ints))
...
def assertPB_geq( S ,  rhs ,  n_args ,  literals ,  coefficients ):
    ...
    _assertPB_geq_monosat((<void*>S), (<int>rhs), (<int>n_args), (<int*>a.data.as_ints), (<int*>b.data.as_ints))
...
def assertPB_gt( S ,  rhs ,  n_args ,  literals ,  coefficients ):
    ...
    _assertPB_gt_monosat((<void*>S), (<int>rhs), (<int>n_args), (<int*>a.data.as_ints), (<int*>b.data.as_ints))
...
def assertPB_leq( S ,  rhs ,  n_args ,  literals ,  coefficients ):
    ...
    _assertPB_leq_monosat((<void*>S), (<int>rhs), (<int>n_args),  (<int*>a.data.as_ints), (<int*>b.data.as_ints))
...
def assertPB_lt( S ,  rhs ,  n_args ,  literals ,  coefficients ):
    ...
    _assertPB_lt_monosat((<void*>S), (<int>rhs), (<int>n_args), (<int*>a.data.as_ints), (<int*>b.data.as_ints))
...
def at_most_one( S ,  vars ,  n_vars ):
    ...
    _at_most_one_monosat((<void*>S),  (<int*>a.data.as_ints), (<int>n_vars))
...
def bv_max( S ,  bv ,  args ,  n_args ,  resultID ):
    ...
    _bv_max_monosat((<void*>S), (<void*>bv),(<int*>a.data.as_ints), (<int>n_args), (<int>resultID))
...
def bv_min( S ,  bv ,  args ,  n_args ,  resultID ):
    ...
    _bv_min_monosat((<void*>S), (<void*>bv), (<int*>a.data.as_ints), (<int>n_args), (<int>resultID))
...
def bv_popcount( S ,  bv ,  args ,  n_args ,  resultID ):
    ...
    _bv_popcount_monosat((<void*>S), (<void*>bv),(<int*>a.data.as_ints), (<int>n_args), (<int>resultID))
...
def bv_unary( S ,  bv ,  args ,  n_args ,  resultID ):
    ...
    _bv_unary_monosat((<void*>S), (<void*>bv), (<int*>a.data.as_ints), (<int>n_args), (<int>resultID))
...
def disallowLiteralSimplification( S ,  lit ):
    ...
    cdef bint _r = _disallowLiteralSimplification_monosat((<void*>S), (<int>lit))
    py_result = <bint>_r
    return py_result
...
def getConflictClause( S ,  store_clause ,  max_store_size ):
    ...
    cdef int _r = _getConflictClause_monosat((<void*>S),(<int*>a.data.as_ints), (<int>max_store_size))
    py_result = <int>_r
    return py_result
...
def getDecisionPolarity( S ,  v ):
    ...
    cdef bint _r = _getDecisionPolarity_monosat((<void*>S), (<int>v))
    py_result = <bint>_r
    return py_result
...
def getModel_BV( S ,  bv ,  bvID ,  getMaximumValue ):
    ...
    cdef int64_t _r = _getModel_BV_monosat((<void*>S), (<void*>bv), (<int>bvID), (<bint>getMaximumValue))
    py_result = <int64_t>_r
    return py_result
...
def getModel_Path_EdgeLits( S ,  G ,  reach_or_distance_literal ,  store_length ,  store ):
    ...
    cdef int _r = _getModel_Path_EdgeLits_monosat((<void*>S), (<void*>G), (<int>reach_or_distance_literal), (<int>store_length), (<int*>a.data.as_ints))
    py_result = <int>_r
    return py_result
...
def getModel_Path_Nodes( S ,  G ,  reach_or_distance_literal ,  store_length ,  store ):
    ...
    cdef int _r = _getModel_Path_Nodes_monosat((<void*>S), (<void*>G), (<int>reach_or_distance_literal), (<int>store_length),(<int*>a.data.as_ints))
    py_result = <int>_r
    return py_result
...
def isDecisionVar( S ,  var ):
    ...
    cdef bint _r = _isDecisionVar_monosat((<void*>S), (<int>var))
    py_result = <bint>_r
    return py_result
...
def lastSolutionWasOptimal( S ):
    ...
    cdef bint _r = _lastSolutionWasOptimal_monosat((<void*>S))
    py_result = <bint>_r
    return py_result
...
def maximizeLits( S ,  lits ,  n_lits ):
    ...
    _maximizeLits_monosat((<void*>S), (<int*>a.data.as_ints), (<int>n_lits))
...
def maximizeWeightedLits( S ,  lits ,  weights ,  n_lits ):
    ...
    _maximizeWeightedLits_monosat((<void*>S), (<int*>a.data.as_ints), (<int*>b.data.as_ints), (<int>n_lits))
...
def minimizeLits( S ,  lits ,  n_lits ):
    ...
    _minimizeLits_monosat((<void*>S), (<int*>a.data.as_ints), (<int>n_lits))
...
def minimizeWeightedLits( S ,  lits ,  weights ,  n_lits ):
    ...
    _minimizeWeightedLits_monosat((<void*>S), (<int*>a.data.as_ints), (<int*>b.data.as_ints), (<int>n_lits))
...
def newBitvector( S ,  bv ,  bits ,  n_bits ):
    ...
    cdef int _r = _newBitvector_monosat((<void*>S), (<void*>bv), (<int*>a.data.as_ints), (<int>n_bits))
    py_result = <int>_r
    return py_result
...
def newEdgeSet( S ,  G ,  edges ,  n_edges ,  enforceEdgeAssignment ):
    ...
    _newEdgeSet_monosat((<void*>S), (<void*>G), (<int*>a.data.as_ints), (<int>n_edges), (<bint>enforceEdgeAssignment))
...
def setDecisionPolarity( S ,  v ,  b ):
    ...
    _setDecisionPolarity_monosat((<void*>S), (<int>v), (<bint>b))
...
def setDecisionVar( S ,  var ,  decidable ):
    ...
    _setDecisionVar_monosat((<void*>S), (<int>var), (<bint>decidable))
...
def solve( S ):
    ...
    cdef bint _r = _solve_monosat((<void*>S))
    py_result = <bint>_r
    return py_result
...
def solveAssumptions( S ,  assumptions,  n_assumptions):
    ...
    cdef bint _r = _solveAssumptions_monosat((<void*>S), <int*>a.data.as_ints, (<int>n_assumptions))
    py_result = <bint>_r
    return py_result
...
def solveAssumptionsLimited( S ,  assumptions ,  n_assumptions ):
    ...
    cdef array.array a =  array.array('i', assumptions)
    cdef int _r = _solveAssumptionsLimited_monosat((<void*>S), (<int*>a.data.as_ints), (<int>n_assumptions))
    py_result = <int>_r
    return py_result
